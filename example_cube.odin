...
create_buffers :: proc() -> (u32, u32, u32) {
    ...
    BufferData(ARRAY_BUFFER, size_of_val(cubeVertices), &cubeVertices[0], STATIC_DRAW);
    ...
    BufferData(ELEMENT_ARRAY_BUFFER, size_of_val(cubeIndices), &cubeIndices[0], STATIC_DRAW);
